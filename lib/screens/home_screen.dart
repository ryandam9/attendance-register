...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _init() async {
    await context.read<OfficeProvider>().load();
    _refreshAttendance();
  }

  void _refreshAttendance() {
    final office = context.read<OfficeProvider>().selectedOffice;
    if (office == null) return;
    context.read<AttendanceProvider>().loadForMonth(
      office.id!,
      _focusedDay.year,
      _focusedDay.month,
    );
    ...
    return Scaffold(
      ...
      body: Consumer<OfficeProvider>(
        builder: (context, officeProvider, _) {
          if (officeProvider.loading) {
            return const Center(child: CircularProgressIndicator());
          }

          if (!officeProvider.hasOffice) {
            return _EmptyState(
          ...
          return _Dashboard(
            offices: officeProvider.offices,
            selected: officeProvider.selectedOffice!,
            focusedDay: _focusedDay,
            calendarFormat: _calendarFormat,
            onOfficeChanged: (o) {
              officeProvider.selectOffice(o);
              _refreshAttendance();
            },
              ...
              Padding(
                ...
                child: DropdownButtonFormField<OfficeLocation>(
                  ...
                  items: offices
                      ...
                      .toList(),
                  onChanged: (o) { if (o != null) onOfficeChanged(o); },
                ),
              ),
